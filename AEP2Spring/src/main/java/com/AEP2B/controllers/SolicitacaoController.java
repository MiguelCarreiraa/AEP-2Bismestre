...
public class SolicitacaoController {
  ...
  public ResponseEntity<List<SolicitacaoModel>> buscarPorCategoria(
  ...
  public ResponseEntity<SolicitacaoModel> atualizar(@PathVariable Long id,
    ...
    if (solicitacaoService.buscarPorId(id).isEmpty()) {
  ...
  /**
   * CORREÇÃO CRÍTICA: Antes: salvava sempre com usuario = NULL porque o frontend não mandava o
   * objeto usuario e o controller ignorava quem estava logado.
   * <p>
   * Agora: se Authentication não for null (usuário logado), o controller busca o UsuarioModel pelo
   * email e vincula à solicitação. Se for anônimo (null), salva sem usuário — comportamento
   * esperado.
   * <p>
